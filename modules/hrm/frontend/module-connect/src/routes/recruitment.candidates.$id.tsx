...
export const Route = createFileRoute("/recruitment/candidates/$id")({
  head: () => ({
    meta: [
      { title: "Candidate — Meridian ERP HRM" },
      {
        name: "description",
        content:
          "Selection pipeline, interview scorecards, reference and background checks, retention basis and the offer decision.",
      },
      { property: "og:title", content: "Candidate — Meridian ERP HRM" },
      {
        ...
        {({ candidate: c, vacancy, requisition, peers }) => {
          ...
          return (
            <RecordDetail
              ...
              secondaryActions={
                <>
                  <Button variant="outline" size="sm" asChild>
                    <Link to="/recruitment/candidates">Back to candidates</Link>
                  </Button>
                  <Button variant="outline" size="sm" asChild>
                    <Link to="/recruitment/vacancies">View the vacancy</Link>
                  </Button>
                </>
              }
              summary={[
              ...
              related={
                <>
                  <Link to="/recruitment/vacancies" className="block text-primary underline underline-offset-2">
                    {vacancy ? `${vacancy.id} — ${vacancy.jobTitle}` : "Vacancies"}
                  </Link>
                  <Link to="/recruitment/requisitions" className="block text-primary underline underline-offset-2">
