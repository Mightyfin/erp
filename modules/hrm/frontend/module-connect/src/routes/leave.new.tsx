        ...
        submitted={
          ref ? (
            <NextSteps
              ...
              actions={<><Button onClick={() => navigate({ to: "/leave" })}>View my requests</Button><Button variant="outline" asChild><Link to="/">Back to Home</Link></Button></>}
            />
          ) : undefined
        }
      />
