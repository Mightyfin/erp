...
export const Route = createFileRoute("/time/expenses/new")({
  head: () => ({
    meta: [
      { title: "New expense claim — Meridian ERP HRM" },
      ...
      { property: "og:title", content: "New expense claim — Meridian ERP HRM" },
    ...
    return (
      <AppShell>
        ...
        <NextSteps
          ...
          actions={
            <>
              <Button onClick={() => navigate({ to: "/time/expenses" })}>View my claims</Button>
              <Button variant="outline" asChild>
                <Link to="/time/travel">Back to travel</Link>
              </Button>
            </>
          }
        />
      ...
      <PageHeader
        ...
        primaryAction={
          <Button variant="ghost" asChild>
            <Link to="/time/expenses">Cancel</Link>
          </Button>
        }
      />
      <GuidedFlow
