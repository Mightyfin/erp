...
export const Route = createFileRoute("/lifecycle/offboarding/$id")({
  head: () => ({
    meta: [
      { title: "Separation case — Meridian ERP HRM" },
      { name: "description", content: "Clearance checklist, consolidated blockers and final separation sign-off." },
      { property: "og:title", content: "Separation case — Meridian ERP HRM" },
            ...
            <RecordDetail
              ...
              secondaryActions={
                <>
                  ...
                  <Button variant="outline" asChild>
                    <Link to="/lifecycle/offboarding">All separation cases</Link>
                  </Button>
                </>
              }
              summary={[
              ...
              related={
                <>
                  ...
                  <p>
                    <Link to="/payslips" className="text-primary underline underline-offset-2">
