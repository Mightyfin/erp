        ...
        submitted={
          ref ? (
            <NextSteps
              ...
              actions={<><Button onClick={() => navigate({ to: "/attendance" })}>View corrections</Button><Button variant="outline" asChild><Link to="/">Back to Home</Link></Button></>}
            />
          ) : undefined
        }
      />
