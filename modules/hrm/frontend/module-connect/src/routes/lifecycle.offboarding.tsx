...
export const Route = createFileRoute("/lifecycle/offboarding")({
  head: () => ({
    meta: [
      { title: "Offboarding — Meridian ERP HRM" },
      ...
      { property: "og:title", content: "Offboarding — Meridian ERP HRM" },
