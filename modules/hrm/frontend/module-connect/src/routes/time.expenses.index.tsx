...
export const Route = createFileRoute("/time/expenses/")({
  head: () => ({
    meta: [
      { title: "Expenses — Meridian ERP HRM" },
      { name: "description", content: "Expense claims and outstanding advances, reconciled so you always know who owes whom." },
      { property: "og:title", content: "Expenses — Meridian ERP HRM" },
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        primaryAction={
          <Button asChild>
            <Link to="/time/expenses/new">New expense claim</Link>
          </Button>
        }
      />
