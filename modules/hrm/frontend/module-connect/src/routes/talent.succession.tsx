...
export const Route = createFileRoute("/talent/succession")({
  head: () => ({
    meta: [
      { title: "Succession and skills — Meridian ERP HRM" },
      { name: "description", content: "Which roles would hurt to lose, who could step up, and where the skills gaps are." },
      { property: "og:title", content: "Succession and skills — Meridian ERP HRM" },
