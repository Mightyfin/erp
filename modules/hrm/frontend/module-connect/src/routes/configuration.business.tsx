...
export const Route = createFileRoute("/configuration/business")({
  head: () => ({
    meta: [
      { title: "Business setup — Meridian ERP HRM" },
      { name: "description", content: "Grades and pay ranges, calendars, country packs, languages and payroll components." },
      { property: "og:title", content: "Business setup — Meridian ERP HRM" },
