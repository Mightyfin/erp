...
export const Route = createFileRoute("/payroll/runs/$id/edit")({
  head: () => ({
    meta: [
      { title: "Edit pay run — Meridian ERP HRM" },
      ...
      { property: "og:title", content: "Edit pay run — Meridian ERP HRM" },
        ...
        {(run) => {
          ...
          return (
            <EditPage
              ...
              onCancel={() => navigate({ to: "/payroll/runs/$id", params: { id } })}
              onSave={(_values, changed) => {
                ...
                navigate({ to: "/payroll/runs/$id", params: { id } });
              }}
            />
          );
        }}
