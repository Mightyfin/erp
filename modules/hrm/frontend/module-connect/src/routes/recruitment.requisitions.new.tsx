...
export const Route = createFileRoute("/recruitment/requisitions/new")({
  head: () => ({
    meta: [
      { title: "Raise a requisition — Meridian ERP HRM" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Raise a requisition — Meridian ERP HRM" },
      {
        ...
        submitted={
          ref ? (
            <NextSteps
              ...
              actions={
                <>
                  <Button onClick={() => navigate({ to: "/recruitment/requisitions" })}>View requisitions</Button>
                  <Button variant="outline" asChild>
                    <Link to="/recruitment/vacancies">Go to vacancies</Link>
                  </Button>
                </>
              }
            />
