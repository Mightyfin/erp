...
export const Route = createFileRoute("/payslips/$id")({
  head: () => ({
    meta: [
      { title: "Payslip — Meridian ERP HRM" },
      { name: "description", content: "Every line explained: the calculation, the rule version and the difference from last period." },
      { property: "og:title", content: "Payslip — Meridian ERP HRM" },
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border bg-surface p-5">
                ...
                <Button asChild variant="outline" className="mt-3">
                  <Link to="/requests/new">Raise a payroll query</Link>
                </Button>
              </div>
            </div>
          );
