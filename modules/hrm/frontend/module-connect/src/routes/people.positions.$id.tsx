...
export const Route = createFileRoute("/people/positions/$id")({
  head: () => ({
    meta: [
      { title: "Position — Meridian ERP HRM" },
      {
        name: "description",
        content:
          "Position record: requirements, pay band, incumbency history, mandatory licences and establishment funding.",
      },
      { property: "og:title", content: "Position — Meridian ERP HRM" },
      {
                ...
                <>
                  {p.incumbentId ? (
                    <Button variant="outline" size="sm" asChild>
                      <Link to="/employees/$id" params={{ id: p.incumbentId }}>
                        Open incumbent profile
                      </Link>
                    </Button>
                  ) : null}
                  <Button variant="outline" size="sm" asChild>
                    <Link to="/people/org">View in organisation structure</Link>
                  </Button>
                  <Button variant="outline" size="sm" asChild>
                    <Link to="/people/positions">Back to positions</Link>
                  </Button>
                </>
              }
              summary={[
