...
export const Route = createFileRoute("/talent/reviews/$id")({
  head: () => ({
    meta: [
      { title: "Performance review — Meridian ERP HRM" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Performance review — Meridian ERP HRM" },
      {
...
function ReviewBody({ review }: { review: Review }) {
  ...
  return (
    <RecordDetail
      ...
      related={
        <>
          <Link to="/talent/goals" className="block text-primary underline underline-offset-2">
            Goals for this cycle
          </Link>
          <Link to="/talent/learning" className="block text-primary underline underline-offset-2">
