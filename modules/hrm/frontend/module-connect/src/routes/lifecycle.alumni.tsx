...
export const Route = createFileRoute("/lifecycle/alumni")({
  head: () => ({
    meta: [
      { title: "Alumni and rehire — Meridian ERP HRM" },
      { name: "description", content: "Former colleagues, whether they can be rehired, and their previous service." },
      { property: "og:title", content: "Alumni and rehire — Meridian ERP HRM" },
