...
export const Route = createFileRoute("/configuration/process")({
  head: () => ({
    meta: [
      { title: "Process design — Meridian ERP HRM" },
      { name: "description", content: "Leave policies, shift rules, approval routing, request categories, forms, automation and templates." },
      { property: "og:title", content: "Process design — Meridian ERP HRM" },
