...
export const Route = createFileRoute("/relations/ethics")({
  head: () => ({
    meta: [
      { title: "Ethics and declarations — Meridian ERP HRM" },
      { name: "description", content: "Conflicts of interest, outside employment, gifts and related-party declarations." },
      { property: "og:title", content: "Ethics and declarations — Meridian ERP HRM" },
