...
export const Route = createFileRoute("/talent/reviews")({
  head: () => ({
    meta: [
      { title: "Performance reviews — Meridian ERP HRM" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Performance reviews — Meridian ERP HRM" },
      {
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        primaryAction={
          <Button asChild>
            <Link to="/talent/reviews/$id" params={{ id: "rv-2041" }}>
