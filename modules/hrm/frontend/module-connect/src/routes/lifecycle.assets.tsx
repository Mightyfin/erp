...
export const Route = createFileRoute("/lifecycle/assets")({
  head: () => ({
    meta: [
      { title: "Assets and access — Meridian ERP HRM" },
      { name: "description", content: "What each person holds, and what comes back when they leave." },
      { property: "og:title", content: "Assets and access — Meridian ERP HRM" },
