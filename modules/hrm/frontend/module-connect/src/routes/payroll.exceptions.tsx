...
export const Route = createFileRoute("/payroll/exceptions")({
  head: () => ({
    meta: [
      { title: "Payroll exceptions — Meridian ERP HRM" },
      { name: "description", content: "What is blocking release, what it would cost, and the safe way to resolve it." },
      { property: "og:title", content: "Payroll exceptions — Meridian ERP HRM" },
