...
export const Route = createFileRoute("/lifecycle/movements")({
  head: () => ({
    meta: [
      { title: "Movements — Meridian ERP HRM" },
      ...
      { property: "og:title", content: "Movements — Meridian ERP HRM" },
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        primaryAction={
          <Button asChild>
            <Link to="/lifecycle/movements/new">Raise a movement</Link>
          </Button>
        }
      />
      <Async state={state}>
