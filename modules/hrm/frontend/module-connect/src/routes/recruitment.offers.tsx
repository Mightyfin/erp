...
export const Route = createFileRoute("/recruitment/offers")({
  head: () => ({
    meta: [
      { title: "Offers and referrals — Meridian ERP HRM" },
      { name: "description", content: "Offers with their position against band, and referral rewards." },
      { property: "og:title", content: "Offers and referrals — Meridian ERP HRM" },
