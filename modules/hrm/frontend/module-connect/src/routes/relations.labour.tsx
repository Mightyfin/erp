...
export const Route = createFileRoute("/relations/labour")({
  head: () => ({
    meta: [
      { title: "Agreements and roll call — Meridian ERP HRM" },
      { name: "description", content: "Collective agreements and their terms, plus emergency roll call." },
      { property: "og:title", content: "Agreements and roll call — Meridian ERP HRM" },
