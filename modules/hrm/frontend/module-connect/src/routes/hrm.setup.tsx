  ...
  const steps: FlowStep[] = [
    {
      ...
      render: () => (
        <div className="grid gap-4 sm:grid-cols-2">
          <Field id="org-name" label="Organisation name" defaultValue="Mighty Finance Solutions Industrial Services" />
    ...
    },
    {
      ...
      render: () => (
        <dl className="grid gap-3 sm:grid-cols-2">
          {[
            ["Organisation", "Mighty Finance Solutions Industrial Services · NL"],
      ...
      <GuidedFlow
        ...
        submitted={
            ...
            <NextSteps
              ...
              actions={
                <Button onClick={() => navigate({ to: "/hrm" })}>Go to Home</Button>
              }
            />
          ) : undefined
        }
