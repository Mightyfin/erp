...
export const Route = createFileRoute("/relations/safety")({
  head: () => ({
    meta: [
      { title: "Health and safety — Meridian ERP HRM" },
      { name: "description", content: "Report an incident or hazard, and track investigations and corrective actions." },
      { property: "og:title", content: "Health and safety — Meridian ERP HRM" },
