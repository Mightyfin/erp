              ...
              <DetailSection
                ...
                action={
                  <Button variant="outline" size="sm" asChild>
                    <Link to="/payroll/runs/$id/edit" params={{ id: run.id }}>
                      Edit this run
                    </Link>
                  </Button>
                }
                  ...
                  {selfApproval ? (
                    ...
                    <div className="rounded-lg border border-warning/40 bg-warning-soft p-4">
                      ...
                      <Button variant="outline" className="mt-3" asChild>
                        <Link to="/payroll/exceptions">Review exceptions</Link>
                      </Button>
                    </div>
                  ) : (
                    <ApprovalPanel
