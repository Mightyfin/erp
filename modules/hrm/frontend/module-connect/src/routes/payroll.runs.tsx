  ...
  return (
    <AppShell>
      <PageHeader
        ...
        primaryAction={
          <Button asChild>
            <Link to="/payroll/runs/new">Start a pay run</Link>
          </Button>
        }
      />
        ...
        {(rows) => (
          <ListPage<PayRun>
            ...
            filters={[
              ...
              { id: "entity", label: "Entity", options: ["Meridian Industrial Services Zambia Ltd", "Meridian Copperbelt Services Ltd", "Meridian Engineering Zambia Ltd"], match: (r, v) => r.entityName === v },
            ]}
            columns={[
              {
                id: "ref",
                ...
                cell: (r) => (
                  <span className="block min-w-0 max-w-64">
                    <Link to="/payroll/runs/$id" params={{ id: r.id }} className="block truncate font-medium text-primary underline-offset-2 hover:underline">
                      {r.period} · {r.payGroup}
                    </Link>
