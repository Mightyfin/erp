...
export const Route = createFileRoute("/configuration/compliance")({
  head: () => ({
    meta: [
      { title: "Security and compliance — Meridian ERP HRM" },
      { name: "description", content: "Protected-disclosure handling, privacy and consent administration, retention and audit." },
      { property: "og:title", content: "Security and compliance — Meridian ERP HRM" },
      ...
      {tab === "privacy" ? (
        <>
          ...
          <Button variant="outline" size="sm" className="mt-3" asChild>
            <Link to="/people/privacy">View the employee privacy page</Link>
          </Button>
        </>
      ) : null}
