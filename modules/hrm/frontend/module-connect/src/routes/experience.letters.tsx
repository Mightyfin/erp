...
export const Route = createFileRoute("/experience/letters")({
  head: () => ({
    meta: [
      { title: "Letters — Meridian ERP HRM" },
      { name: "description", content: "Request an employment letter and see exactly what it will say before it is issued." },
      { property: "og:title", content: "Letters — Meridian ERP HRM" },
        ...
        <div className="max-w-xl space-y-4">
          <div className="rounded-lg border bg-surface-muted p-4 text-sm leading-relaxed">
            ...
            <p className="mt-3">
              ...
              employed by Meridian Industrial Services Zambia Ltd as{" "}
    ...
    <AppShell>
      ...
      <section aria-label="Previously issued" className="pt-2">
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          ...
          <Link to="/requests/new" className="text-primary underline underline-offset-2">
            Raise an HR request
          </Link>
          .
        </p>
