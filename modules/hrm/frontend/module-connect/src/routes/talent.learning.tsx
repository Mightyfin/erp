...
export const Route = createFileRoute("/talent/learning")({
  head: () => ({
    meta: [
      { title: "Learning — Meridian ERP HRM" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Learning — Meridian ERP HRM" },
      {
          ...
          return (
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <Link to="/talent/goals" className="text-primary underline underline-offset-2">
                  goals
                </Link>{" "}
