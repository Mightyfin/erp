...
export const Route = createFileRoute("/pay/compensation")({
  head: () => ({
    meta: [
      { title: "Compensation and benefits — Meridian ERP HRM" },
      { name: "description", content: "Pay against band, benefit enrolment, review cycles, pay-gap reporting and insurance claims." },
      { property: "og:title", content: "Compensation and benefits — Meridian ERP HRM" },
