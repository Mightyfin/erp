...
export const Route = createFileRoute("/configuration/organisation")({
  head: () => ({
    meta: [
      { title: "Organisation setup — Meridian ERP HRM" },
      { name: "description", content: description },
      { property: "og:title", content: "Organisation setup — Meridian ERP HRM" },
