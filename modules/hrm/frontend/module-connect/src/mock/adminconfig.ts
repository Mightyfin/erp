...
export const legalEntityConfigs: LegalEntityConfig[] = [
  {
    id: "cfg-ent-zm1",
    entityId: "ent-zm1",
    registeredName: "Meridian Industrial Services Zambia Ltd",
    country: "Zambia",
  ...
  },
  {
    id: "cfg-ent-zm2",
    entityId: "ent-zm2",
    registeredName: "Meridian Copperbelt Services Ltd",
    country: "Zambia",
    legalIdLabel: "PACRA / TPIN",
  ...
  },
  {
    id: "cfg-ent-zm3",
    entityId: "ent-zm3",
    registeredName: "Meridian Engineering Zambia Ltd",
    country: "Zambia",
    legalIdLabel: "PACRA / TPIN",
...
export const scheduledChanges: ScheduledChange[] = [
  ...
  },
  {
    ...
    change: "Open new work location under Meridian Industrial Services Zambia Ltd",
    effectiveFrom: "2026-10-01",
  ...
  },
  {
    id: "chg-005",
    scope: "Legal entity",
    unit: "Meridian Engineering Zambia Ltd",
...
export const structureAudit: TimelineEvent[] = [
  ...
  },
  {
    ...
    actor: "Thandiwe Banda",
    event: "Scheduled registered address change for Meridian Engineering Zambia Ltd",
...
export const roleDefs: RoleDef[] = [
  ...
  },
  {
    ...
    scope: "Entity",
    scopeNote:
      "Assigned to Meridian Industrial Services Zambia Ltd only. A second holder is needed for the Zambian entity.",
    administrative: false,
  },
  {
    id: "payroll",
...
export const sodRules: SodRule[] = [
  ...
  },
  {
    ...
    mitigated: true,
    mitigation:
      "Accepted for Meridian Industrial Services Zambia Ltd until a second HR operations holder is appointed. Reviewed on 30 June 2026, next review 31 December 2026.",
  },
  {
    id: "sod-3",
