...
export const onboardings: OnboardingCase[] = [
  {
    ...
    entity: "Mighty Finance Solutions Engineering Zambia Ltd",
  ...
  },
  {
    ...
    entity: "Mighty Finance Solutions Industrial Services Zambia Ltd",
    branch: "Ndola Plant",
  ...
  },
  {
    ...
    department: "Finance",
    entity: "Mighty Finance Solutions Copperbelt Services Ltd",
  ...
  },
  {
    ...
    clearance: [
      ...
      },
      {
        ...
        detail: "External access sponsored by Mighty Finance Solutions; withdrawal must be filed with the port authority.",
        owner: "HR",
        ownerName: "Thandiwe Banda",
        dueDate: "2026-07-26",
        state: "Blocked",
