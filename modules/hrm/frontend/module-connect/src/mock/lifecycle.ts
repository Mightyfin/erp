...
export const onboardings: OnboardingCase[] = [
  {
    ...
    entity: "New World Cargo Engineering Zambia Ltd",
  ...
  },
  {
    ...
    entity: "New World Cargo Logistics Zambia Ltd",
    branch: "Ndola Plant",
  ...
  },
  {
    ...
    department: "Finance",
    entity: "New World Cargo Copperbelt Services Ltd",
  ...
  },
  {
    ...
    clearance: [
      ...
      },
      {
        ...
        detail: "External access sponsored by New World Cargo; withdrawal must be filed with the port authority.",
        owner: "HR",
        ownerName: "Thandiwe Banda",
        dueDate: "2026-07-26",
        state: "Blocked",
