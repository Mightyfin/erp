...
export const onboardings: OnboardingCase[] = [
  {
    ...
    entity: "Meridian Engineering Zambia Ltd",
  ...
  },
  {
    ...
    entity: "Meridian Industrial Services Zambia Ltd",
    branch: "Ndola Plant",
  ...
  },
  {
    ...
    department: "Finance",
    entity: "Meridian Copperbelt Services Ltd",
  ...
  },
  {
    ...
    clearance: [
      ...
      },
      {
        ...
        detail: "External access sponsored by Meridian; withdrawal must be filed with the port authority.",
        owner: "HR",
        ownerName: "Thandiwe Banda",
        dueDate: "2026-07-26",
        state: "Blocked",
