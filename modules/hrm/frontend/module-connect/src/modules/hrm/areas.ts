...
export const areas = {
  ...
  schedules: {
    ...
    capabilities: [
      ...
      { label: "Compensatory time and time off in lieu", detail: "Accrual, expiry and payout where permitted.", tier: "Advanced", state: "built", to: "/hrm/time/toil" },
    ],
  },
  timesheets: {
    eyebrow: "Time operations",
    ...
    capabilities: [
      { label: "Timesheet submission and approval", detail: "Line and project-manager approval with locking.", tier: "Advanced", state: "built", to: "/hrm/time/timesheets" },
      { label: "Project and cost-centre allocation", detail: "Billable and non-billable, ordinary and overtime hours.", tier: "Advanced", state: "built", to: "/hrm/time/timesheets" },
      { label: "Payroll and accounting hand-off", detail: "Approved hours as payroll input and project cost.", tier: "Advanced", state: "built", to: "/hrm/time/utilisation" },
      { label: "Utilisation reporting", detail: "Labour cost and utilisation by project and team.", tier: "Advanced", state: "built", to: "/hrm/time/utilisation" },
    ],
  },
  expenses: {
    eyebrow: "Time operations",
    ...
    capabilities: [
      { label: "Travel authorisation", detail: "Purpose, itinerary, per diem and travel advance.", tier: "Advanced", state: "built", to: "/hrm/time/travel" },
      { label: "Expense claims", detail: "Receipts, categories, policy limits and duplicate detection.", tier: "Advanced", state: "built", to: "/hrm/time/expenses" },
      { label: "Advance reconciliation", detail: "Return of unused funds and outstanding-advance control.", tier: "Advanced", state: "built", to: "/hrm/time/travel" },
      { label: "Reimbursement", detail: "Payroll or accounts-payable settlement route.", tier: "Advanced", state: "built", to: "/hrm/time/expenses" },
    ],
  },
  compensation: {
    eyebrow: "Payroll",
